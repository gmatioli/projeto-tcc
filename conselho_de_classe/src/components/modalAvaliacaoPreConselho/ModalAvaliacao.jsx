  ...
  return (
    ...
    <div className="flex justify-center items-center fixed top-0 left-0 right-0 bottom-0 bg-black/50 z-[1000]" >
      ...
      <div className="flex flex-col bg-white p-5 rounded-[10px] ml-[18vw]  mt-[8vh] w-[1200px] max-w-[90%] h-[800px]">
        ...
        <hr className="border-none bg-gray-300 h-[2px] py-[1px] mx-20"/>
        ...
        <form className="mx-20">
          ...
          <div className="flex justify-center items-end gap-[50px] mt-[30px]">
            ...
            <button type="button" onClick={onClose} className="py-2 px-[120px] rounded-[50px] text-xl border border-black shadow-[0_0_3px_gray] cursor-pointer">
              Cancelar
            </button>
            <button type="submit" className="py-2 px-[120px] rounded-[50px] text-xl border border-black bg-[#E53935] shadow-[0_0_3px_gray] text-white cursor-pointer">
              Salvar
            </button>
          </div>
        </form>
